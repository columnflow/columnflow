...
from __cf_short_name_lc__.config.datasets import add_datasets, configure_datasets, get_dataset_lfns
...
def add_config(
    ...
    add_ttz_processes(cfg, campaign)

    add_triggers(cfg, campaign)
    add_ttz_datasets(cfg, campaign)

    cfg.x.get_dataset_lfns = get_dataset_lfns

    configure_ttz_datasets(cfg, limit_dataset_files)
