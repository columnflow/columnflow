...
@selector
def jet_energy_shifts(self, events, **kwargs):
    return events
...
def req_jet(self, events, **kwargs):
...
def req_electron(self, events, **kwargs):
...
def req_muon(self, events, **kwargs):
...
def deepjet_selection_test(self, events, stats, **kwargs):
...
def muon_selection_test(self, events, stats, **kwargs):
    # example cuts:
...
def electron_selection_test(self, events, stats, **kwargs):
    # example cuts:
    # - require exactly one muon with pt>25, eta<2.4 and tight Id
...
def lepton_selection_test(self, events, stats, **kwargs):
    # example cuts:
