...
class PlotCutflowVariables(
    ...
    plot_function_name_per_process = "ap.plotting.variables.plot_variable_per_process"
    plot_function_name_per_step = "ap.plotting.variables.plot_variable_variants"
