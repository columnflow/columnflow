...
import columnflow.config.processes as procs
from columnflow.config.campaign_2018 import campaign_2018
from columnflow.config.categories import add_categories
from columnflow.config.variables import add_variables
