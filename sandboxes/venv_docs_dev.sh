...
action() {
    ...
    export CF_VENV_REQUIREMENTS="${CF_BASE}/docs/requirements.txt,${CF_BASE}/requirements_prod.txt,${CF_BASE}/requirements_dev.txt,${CF_BASE}/sandboxes/columnar.txt,${CF_BASE}/sandboxes/ml_tf.txt"
